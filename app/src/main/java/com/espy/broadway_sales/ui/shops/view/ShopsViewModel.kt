...
import com.espy.broadway_sales.repository.ShopRepository
import com.espy.broadway_sales.api.models.common.PaymentType
import com.espy.broadway_sales.api.models.shops.*
import com.espy.broadway_sales.ui.base.BaseViewModel
import com.espy.broadway_sales.ui.shops.models.NewShopData
import com.espy.broadway_sales.ui.shops.models.NewShopMultiPartData
...
class ShopsViewModel : BaseViewModel() {
    ...
    var _deliveryShopsList: MutableLiveData<com.espy.broadway_sales.api.Result<List<DeliveryShop>>> = MutableLiveData()
    val deliveryShopsList: LiveData<com.espy.broadway_sales.api.Result<List<DeliveryShop>>>
        get() = _deliveryShopsList


    var _enquiry_agency_List: MutableLiveData<com.espy.broadway_sales.api.Result<List<EnquiryAgencyItem>>> = MutableLiveData()
    val enquiry_agency_List: LiveData<com.espy.broadway_sales.api.Result<List<EnquiryAgencyItem>>>
        get() = _enquiry_agency_List


    var _pendingOrderList: MutableLiveData<com.espy.broadway_sales.api.Result<List<PendingOrder>>> = MutableLiveData()
    val pendingOrderList: LiveData<com.espy.broadway_sales.api.Result<List<PendingOrder>>>
        get() = _pendingOrderList

    var _orderItemsList: MutableLiveData<com.espy.broadway_sales.api.Result<List<OrderItem>>> = MutableLiveData()
    val orderItemsList: LiveData<com.espy.broadway_sales.api.Result<List<OrderItem>>>
        get() = _orderItemsList
    ...
    var _enquiry_List: MutableLiveData<com.espy.broadway_sales.api.Result<List<EnquiryItem>>> = MutableLiveData()
    val enquiry_List: LiveData<com.espy.broadway_sales.api.Result<List<EnquiryItem>>>
        get() = _enquiry_List


    var _followupRes: MutableLiveData<com.espy.broadway_sales.api.Result<Int>> = MutableLiveData()
    val followupRes: LiveData<com.espy.broadway_sales.api.Result<Int>>
        get() = _followupRes


    var _followupHistory: MutableLiveData<com.espy.broadway_sales.api.Result<List<FollowupHistoryItem>>> = MutableLiveData()
    val followupHistory: LiveData<com.espy.broadway_sales.api.Result<List<FollowupHistoryItem>>>
