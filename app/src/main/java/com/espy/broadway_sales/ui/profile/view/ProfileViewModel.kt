...
import com.espy.broadway_sales.api.models.login.LeaveRequest
import com.espy.broadway_sales.repository.ProfileRepository
import com.espy.broadway_sales.api.models.login.LoginResponse
import com.espy.broadway_sales.app.InstanceManager
...
class ProfileViewModel : BaseViewModel() {
    ...
    private val _loginsResponse: MutableLiveData<com.espy.broadway_sales.api.Result<LoginResponse>> = MutableLiveData()
    val loginsResponse: LiveData<com.espy.broadway_sales.api.Result<LoginResponse>>
    get() = _loginsResponse
    ...
    private val _expenseTypesList: MutableLiveData<com.espy.broadway_sales.api.Result<List<ExpenseType>>> = MutableLiveData()
    val expenseTypesList: LiveData<com.espy.broadway_sales.api.Result<List<ExpenseType>>>
