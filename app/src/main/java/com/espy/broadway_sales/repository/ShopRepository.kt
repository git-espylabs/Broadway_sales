...
import com.espy.broadway_sales.api.models.products.TodayMyOrderRequest
...
import com.espy.broadway_sales.domain.toDomain
import com.espy.broadway_sales.domain.toEntity
...
class ShopRepository: BaseRepository() {
    ...
    suspend fun getPendingOrderItemsList(orderItemRequest: OrderItemRequest): com.espy.broadway_sales.api.Result<List<OrderItem>> {
        return try {
            val response = RestServiceProvider
                .getShopService()
